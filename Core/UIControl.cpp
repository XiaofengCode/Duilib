...
void CControlUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue)
{
	...
	else if (_tcscmp(pstrName, _T("leftbordersize")) == 0) SetLeftBorderSize(S*_ttoi(pstrValue));
	else if (_tcscmp(pstrName, _T("topbordersize")) == 0) SetTopBorderSize(S*_ttoi(pstrValue));
	else if (_tcscmp(pstrName, _T("rightbordersize")) == 0) SetRightBorderSize(S*_ttoi(pstrValue));
	else if (_tcscmp(pstrName, _T("bottombordersize")) == 0) SetBottomBorderSize(S*_ttoi(pstrValue));
	...
	else if (_tcscmp(pstrName, _T("width")) == 0) SetFixedWidth(S*_ttoi(pstrValue));
	else if (_tcscmp(pstrName, _T("height")) == 0) SetFixedHeight(S*_ttoi(pstrValue));
	else if (_tcscmp(pstrName, _T("minwidth")) == 0) SetMinWidth(S*_ttoi(pstrValue));
	else if (_tcscmp(pstrName, _T("minheight")) == 0) SetMinHeight(S*_ttoi(pstrValue));
	else if (_tcscmp(pstrName, _T("maxwidth")) == 0) SetMaxWidth(S*_ttoi(pstrValue));
	else if (_tcscmp(pstrName, _T("maxheight")) == 0) SetMaxHeight(S*_ttoi(pstrValue));
